...
print(removeRowAndCol([[1,2,4]],2,3) == " Cannot remove row and col ")
print(removeRowAndCol([[]],2,3) == " Cannot remove row and col ")
print(removeRowAndCol([[2,3,4,5],[8,7,6,5]],0,2) == " Cannot remove row and col ")
print(removeRowAndCol([[2,3,4,5],[8,7,6,5],[0,1,2,3]],1,2) == [[2, 3, 5], [0, 1, 3]])
print(removeRowAndCol([[]],0,2) == " Cannot remove row and col ")
